...
X = train_df[train_df.y_m < test][features]
cols = 1<<len(X.columns)
cols
...
# MAGIC %%time
# MAGIC X = train_df[train_df.y_m < test][features1]
# MAGIC all_cols = X.columns
# MAGIC rest_cols = list(all_cols.copy())
...
test_res.to_csv('../Results/20200922RezultGSK_YL0.csv', index=False)
