...
model = implicit.nearest_neighbours.CosineRecommender(K=100)
...
# 0.024497 - nearest_neighbours.CosineRecommender(K=10) - json1
# 0.002130 - nearest_neighbours.CosineRecommender(K=10) - json2
# 0.002213 - nearest_neighbours.CosineRecommender(K=100) - json2
...
rec_tab1.to_parquet('out/rec_tab2all.parquet', index=False)
...
# MAGIC %sh
# MAGIC ./azcopy copy "out/rec_tab2all.parquet" "https://bricksresult.blob.core.windows.net/data/rec_tab2all.parquet?st=2020-03-04T06%3A58%3A48Z&se=2020-12-05T06%3A58%3A00Z&sp=racwdl&sv=2018-03-28&sr=c&sig=LFmu8D%2FVsGZfEj%2F45W6nldF2lvq2mQr9kFl6AblqUN8%3D"   