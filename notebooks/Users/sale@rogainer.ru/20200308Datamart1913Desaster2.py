...
# MAGIC mkdir models
# MAGIC   
# MAGIC ./azcopy copy "https://bricksresult.blob.core.windows.net/data/20200308wall/grid_part_1.pkl?st=2020-03-04T06%3A58%3A48Z&se=2020-12-05T06%3A58%3A00Z&sp=racwdl&sv=2018-03-28&sr=c&sig=LFmu8D%2FVsGZfEj%2F45W6nldF2lvq2mQr9kFl6AblqUN8%3D" "data/grid_part_1.pkl" 
...
grid_df1.to_pickle('grid_part_1913_17_disaster2.pkl')
grid_df1.sample(17)
...
# MAGIC %sh
# MAGIC   
# MAGIC ./azcopy copy  "grid_part_1913_17_disaster2.pkl"  "https://bricksresult.blob.core.windows.net/data/20200308wall/grid_part_1913_17_disaster2.pkl?st=2020-03-04T06%3A58%3A48Z&se=2020-12-05T06%3A58%3A00Z&sp=racwdl&sv=2018-03-28&sr=c&sig=LFmu8D%2FVsGZfEj%2F45W6nldF2lvq2mQr9kFl6AblqUN8%3D"
