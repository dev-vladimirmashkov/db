...
SELECT CURDISCOUNTCARDID
      ...
      ,KOL_LET
  FROM DF00
  WHERE CURDISCOUNTCARDID = '03961588' and CURDISCOUNTCARDTYPE = '04' 
  """)
...
SELECT DISCOUNTCARDTRANSTYPE
  ...
  FROM DF11 Al INNER JOIN (SELECT CURDISCOUNTCARDID
      ...
      ,KOL_LET
  FROM DF00
  WHERE CURDISCOUNTCARDID = '08463274' and CURDISCOUNTCARDTYPE = '04' ) Ca
...
df.to_parquet('./data/client03961588.parquet', index=False)

# COMMAND ----------

# MAGIC %sh
# MAGIC ./azcopy copy data/client03961588.parquet "https://bricksresult.blob.core.windows.net/data/client/client08463274.parquet?st=2020-03-04T06%3A58%3A48Z&se=2020-12-05T06%3A58%3A00Z&sp=racwdl&sv=2018-03-28&sr=c&sig=LFmu8D%2FVsGZfEj%2F45W6nldF2lvq2mQr9kFl6AblqUN8%3D"  
