...
#     недельные циклы прогнозируем и записываем в дф3
    ...
    df3['WapeDay'] = wape(model.result[-56:-28],data[-28:]).round(2)
...
#     тренд по неделям записываем в дф3
    ...
    df4['WapeWeek'] = wape(model.result[-8:-4],data[-4:]).round(2)
...
df7.to_pickle('grid_part_71.pkl')

# COMMAND ----------

# MAGIC %sh
# MAGIC  
# MAGIC ./azcopy copy "grid_part_71.pkl" "https://bricksresult.blob.core.windows.net/data/20200308wall/grid_part_71.pkl?st=2020-03-04T06%3A58%3A48Z&se=2020-12-05T06%3A58%3A00Z&sp=racwdl&sv=2018-03-28&sr=c&sig=LFmu8D%2FVsGZfEj%2F45W6nldF2lvq2mQr9kFl6AblqUN8%3D" 
