...
purchases[purchases.client_id == 'D0408463274']
...
m_ap = []
recomendations = {}
for js in tqdm(json.loads(l) for l in open(get_shard_path(0))):
...
clients.client_id.sample(10)

# COMMAND ----------

rec = recomendations['D0405955416']
