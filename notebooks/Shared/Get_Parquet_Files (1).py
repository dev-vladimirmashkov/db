...
if any(mount.mountPoint == '/mnt/data1' for mount in dbutils.fs.mounts()):
  dbutils.fs.unmount("/mnt/data1")
dbutils.fs.mount(
source = "wasbs://letoile@alkordatalake.blob.core.windows.net/raw/ml",
mount_point = "/mnt/data1",
extra_configs = {"fs.azure.sas.letoile.alkordatalake.blob.core.windows.net":"?sv=2020-02-10&st=2020-12-31T21%3A00%3A00Z&se=2050-03-31T20%3A59%3A00Z&sr=c&sp=racwdlme&sig=69jYjI73deMsJohT8L9aDGjPE3k9ohHjdzmPPPkTD1s%3D"})
...
DFres.write.parquet('/mnt/data1/SalesLetoil/')